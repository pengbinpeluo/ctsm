...
contains
  ...
  !   to grain, pod and energy (g/m^2)
    ...
    do i = 1, crop%dm_retrans_demand_part_num
    ...
    do i = 1, crop%dm_retrans_supply_part_num
  ...
  !!to the grain part 
    ...
    do i = 1, crop%n_retrans_supply_part_num
